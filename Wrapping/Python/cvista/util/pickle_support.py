...
>>> import cvista.util.pickle_support
...
# it to first use keeps `import cvista.util.pickle_support` (and the pyvista import
# chain that reaches vtkCommonDataModel) from eagerly loading vtkParallelCore.
#
# The deferred import MUST be absolute (`from cvista.vtkParallelCore import ...`), not
...
def unserialize_VTK_data_object(state):
    ...
    from cvista.vtkParallelCore import vtkCommunicator
