...
// fvtk opt-in fast coincident-point merge.
//
...
#ifndef fvtkFastClean_h
#define fvtkFastClean_h
 ...
 * fvtk.EnableFast()) AND the request is the exact-merge default regime:
 ...
 */
// Intra-module linkage (defined in fvtkFastClean.cxx, called from
...
#endif
// VTK-HeaderTest-Exclude: fvtkFastClean.h
