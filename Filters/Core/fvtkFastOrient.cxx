...
// fvtk opt-in fast polygon-orientation pass: VTK adapter over the fvtk parallel
...
// fvtkFastClean / fvtkFastConnectivity.
#include "fvtkFastOrient.h"
...
namespace
{
// Engagement sentinel: when the env var FVTK_FAST_ORIENT_SENTINEL names a path,
...
{
  const char* path = std::getenv("FVTK_FAST_ORIENT_SENTINEL");
